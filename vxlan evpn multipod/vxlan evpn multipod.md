...
####  Задание.
   ...
   Обосновать выбор технологии VXLAN multipod  для объединения трех ЦОД.  Реализовать сетевую схему взаимодействия. Обеспечить L2 связность между ЦОД для overlay сети. 
